...
.didagent__fabio{font-family:Inter,system-ui,Avenir,Helvetica,Arial,sans-serif;position:fixed;aspect-ratio:1;\
    ...
    ease-in-out,width .6s ease-in-out,height .6s ease-in-out;aspect-ratio:.6s ease-in-out;z-index:99999;isolation:isolate;bottom:2%}\
...
.didagent__fabio[data-position=right][data-enabled=false]{right:2%}\
.didagent__fabio[data-position=right][data-enabled=true]{right:13%}\
...
@media (max-width: 600px){.didagent__fabio .didagent__fabio__container{position:fixed;border-radius:0;width:100%;height:100%;\
    max-height:100vh;max-width:100vw;bottom:0;left:0}}\
...
.didagent__fabio .didagent__fabio__container[data-enabled=true]{position:fixed;border-radius:0;width:100%;height:100%;max-height:100vh;\
    max-width:100vw;bottom:0;left:0}}\
@media (min-width: 600px){\
.didagent__fabio .didagent__fabio__container[data-enabled=true]{height:95vh;aspect-ratio:4 / 3}}\
@media (min-width: 1280px){\
.didagent__fabio .didagent__fabio__container[data-enabled=true][data-orientation=horizontal]{aspect-ratio:4 / 3}}\
