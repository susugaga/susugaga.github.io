...
\
@media (orientation: portrait) {\
.didagent__fabio .didagent__fabio__container{position:fixed;border-radius:0;width:96vw;height:96dvh;\
    left:2%; bottom:2%}}\
\
...
\
@media (orientation: portrait) {\
.didagent__fabio .didagent__fabio__container[data-enabled=true]{position:fixed;border-radius:0;width:96vw;height:96dvh;\
    left:2%; bottom:2%}}\
\
@media (orientation: landscape) {\
.didagent__fabio .didagent__fabio__container[data-enabled=true]{width:96vw;height:96dvh;aspect-ratio:4 / 3}}\
\
@media (min-width: 1280px){\
.didagent__fabio .didagent__fabio__container[data-enabled=true][data-orientation=horizontal]{width:96vw;height:96dvh;aspect-ratio:4 / 3}}\
\
