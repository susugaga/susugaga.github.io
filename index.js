...
.didagent__fabio{font-family:Inter,system-ui,Avenir,Helvetica,Arial,sans-serif;position:fixed;aspect-ratio:1;-webkit-transition:opacity .6s ease-in-out,width .6s ease-in-out,height .6s ease-in-out;transition:opacity .6s ease-in-out,width .6s ease-in-out,height .6s ease-in-out;aspect-ratio:.6s ease-in-out;z-index:99999;isolation:isolate;bottom:2%}
.didagent__fabio[data-enabled=false]{width:240px}
.didagent__fabio[data-enabled=true]{width:240px}
.didagent__fabio[data-position=left]{left:2%}
.didagent__fabio[data-position=right]{right:2%}@media (max-height: 550px){.didagent__fabio{display:none}}
